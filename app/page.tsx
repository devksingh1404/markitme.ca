    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <Link href="/" className="flex items-center gap-2">
              <span className="text-2xl font-bold text-slate-900">MARKIT</span>
              <span className="text-2xl font-bold text-cyan-600">ME</span>
            </Link>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-slate-100 bg-white">
              ...
              <Button className="mt-4 w-full bg-slate-900 hover:bg-slate-800 text-white rounded-full">
                Get Started
              </Button>
            </div>
          )}
      ...
      <section className="relative min-h-screen flex items-center hero-gradient overflow-hidden pt-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-cyan-100 rounded-full blur-3xl opacity-60 animate-float" />
          <div className="absolute top-1/2 -left-20 w-60 h-60 bg-slate-200 rounded-full blur-3xl opacity-40 animate-float delay-300" />
          <div className="absolute bottom-20 right-1/4 w-40 h-40 bg-teal-100 rounded-full blur-2xl opacity-50 animate-float delay-500" />
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-full text-sm font-medium animate-fade-up">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight animate-fade-up delay-100">
                ...
                <br />
                <span className="font-playfair italic text-cyan-600">Brands That</span>
                <br />
              ...
              <div className="flex flex-wrap gap-4 animate-fade-up delay-300">
                <Button size="lg" className="bg-slate-900 hover:bg-slate-800 text-white rounded-full px-8 h-14 text-lg group">
                  Start Your Project
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button size="lg" variant="outline" className="rounded-full px-8 h-14 text-lg border-slate-300 hover:bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
              Everything Your Brand Needs to <span className="text-cyan-600">Succeed</span>
            </h2>
          ...
          <div className="mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.brandContent.map((service, idx) => (
                <Card
                  key={idx}
                  className="service-card group cursor-pointer border border-slate-100 hover:border-cyan-200 transition-all duration-300"
                >
                  <CardContent className="p-6">
                    <div className="w-12 h-12 rounded-lg bg-slate-100 group-hover:bg-cyan-50 flex items-center justify-center mb-4 transition-colors">
          ...
          <div className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center text-white">
                <Globe className="w-6 h-6" />
              </div>
              <h3 className="text-2xl font-bold text-slate-900">Digital Presence & Websites</h3>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.digital.map((service, idx) => (
                <Card
                  key={idx}
                  className="service-card group cursor-pointer border border-slate-100 hover:border-slate-300 transition-all duration-300"
                >
                  <CardContent className="p-6">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.marketing.map((service, idx) => (
                <Card
                  key={idx}
                  className="service-card group cursor-pointer border border-slate-100 hover:border-teal-200 transition-all duration-300"
                >
                  <CardContent className="p-6">
                    <div className="w-12 h-12 rounded-lg bg-slate-100 group-hover:bg-teal-50 flex items-center justify-center mb-4 transition-colors">
                      <service.icon className="w-6 h-6 text-slate-700 group-hover:text-teal-600 transition-colors" />
                    </div>
                    <h4 className="text-lg font-semibold text-slate-900 mb-2">{service.title}</h4>
                    <p className="text-slate-500 text-sm">{service.desc}</p>
                  </CardContent>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
                  What Makes Us <span className="font-playfair italic text-cyan-600">Different</span>
                </h2>
                <p className="text-lg text-slate-600">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center text-white shrink-0">
                ...
                <div className="flex gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center text-white shrink-0">
      ...
      <section id="process" className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
              How We <span className="font-playfair italic text-cyan-600">Work</span>
            </h2>
            <p className="text-lg text-slate-600">
      ...
      <section id="work" className="py-24 lg:py-32 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-900/50 text-cyan-300 rounded-full text-sm font-medium mb-4">
              Our Portfolio
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Latest <span className="font-playfair italic text-cyan-400">Projects</span>
            </h2>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
              Frequently Asked <span className="font-playfair italic text-cyan-600">Questions</span>
            </h2>
            <p className="text-slate-600">
              Couldn't find what you were looking for? Write to us at
              <a href="mailto:info@markitme.ca" className="text-cyan-600 hover:underline ml-1">info@markitme.ca</a>
            </p>
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, idx) => (
              <AccordionItem
                key={idx}
                value={`item-${idx}`}
                className="border border-slate-200 rounded-xl px-6 data-[state=open]:bg-slate-50"
              >
        ...
        <div className="relative">
          <div className="flex gap-12 brand-scroll" style={{ width: 'fit-content' }}>
            {[...trustedBrands, ...trustedBrands].map((brand, idx) => (
              <div
                key={idx}
                className="flex items-center justify-center h-16 px-8 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold text-white">
                Ready to Transform <span className="font-playfair italic text-cyan-400">Your Brand?</span>
              </h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 text-slate-300">
                  ...
                  <a href="mailto:info@markitme.ca" className="hover:text-white transition-colors">
                    info@markitme.ca
                  </a>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
              ...
              <div className="flex gap-4 pt-4">
                <a href="https://instagram.com" className="w-10 h-10 rounded-full bg-slate-700 hover:bg-cyan-600 flex items-center justify-center text-white transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="https://facebook.com" className="w-10 h-10 rounded-full bg-slate-700 hover:bg-cyan-600 flex items-center justify-center text-white transition-colors">
                  <Facebook className="w-5 h-5" />
                </a>
                <a href="https://linkedin.com" className="w-10 h-10 rounded-full bg-slate-700 hover:bg-cyan-600 flex items-center justify-center text-white transition-colors">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="https://twitter.com" className="w-10 h-10 rounded-full bg-slate-700 hover:bg-cyan-600 flex items-center justify-center text-white transition-colors">
                ...
                <form className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full px-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-cyan-500 transition-colors"
                        placeholder="John"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-cyan-500 transition-colors">
                  ...
                  <div>
                    ...
                    <textarea
                      rows={4}
                      className="w-full px-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-cyan-500 transition-colors resize-none"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-6">
                <span className="text-2xl font-bold text-white">MARKIT</span>
                <span className="text-2xl font-bold text-cyan-500">ME</span>
              </div>
              <p className="text-slate-400 mb-6">
                We take the time to understand your business, your vision, and your goals.
                Our process is built around strategy, creativity, and measurable results.
              </p>
              <div className="flex gap-3">
                <a href="https://instagram.com" className="w-9 h-9 rounded-full bg-slate-800 hover:bg-cyan-600 flex items-center justify-center text-slate-400 hover:text-white transition-colors">
                  <Instagram className="w-4 h-4" />
                </a>
                <a href="https://facebook.com" className="w-9 h-9 rounded-full bg-slate-800 hover:bg-cyan-600 flex items-center justify-center text-slate-400 hover:text-white transition-colors">
                  <Facebook className="w-4 h-4" />
                </a>
                <a href="https://linkedin.com" className="w-9 h-9 rounded-full bg-slate-800 hover:bg-cyan-600 flex items-center justify-center text-slate-400 hover:text-white transition-colors">
                  <Linkedin className="w-4 h-4" />
                </a>
                <a href="https://twitter.com" className="w-9 h-9 rounded-full bg-slate-800 hover:bg-cyan-600 flex items-center justify-center text-slate-400 hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#services" className="text-slate-400 hover:text-cyan-400 transition-colors">Website Design</Link></li>
                <li><Link href="#services" className="text-slate-400 hover:text-cyan-400 transition-colors">Video Production</Link></li>
                <li><Link href="#services" className="text-slate-400 hover:text-cyan-400 transition-colors">Brand Strategy</Link></li>
                <li><Link href="#services" className="text-slate-400 hover:text-cyan-400 transition-colors">Social Media Marketing</Link></li>
                <li><Link href="#services" className="text-slate-400 hover:text-cyan-400 transition-colors">SEO Optimization</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="#work" className="text-slate-400 hover:text-cyan-400 transition-colors">Our Work</Link></li>
                <li><Link href="#process" className="text-slate-400 hover:text-cyan-400 transition-colors">Our Process</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="text-slate-400">Toronto, Ontario, Canada</li>
                <li><a href="mailto:info@markitme.ca" className="text-slate-400 hover:text-cyan-400 transition-colors">info@markitme.ca</a></li>
                <li><a href="tel:+14165551234" className="text-slate-400 hover:text-cyan-400 transition-colors">+1 (416) 555-1234</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm">
              &copy; {new Date().getFullYear()} MarkitMe.ca All Rights Reserved.
            </p>
